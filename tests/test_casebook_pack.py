"""Regression checks for the signal-trace-slo-dock casebook."""
...
from casebook.harness import assert_expected, signal_trace_slo_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_trace_slo_dock_summary(), assert_expected())
